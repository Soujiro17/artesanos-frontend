...
const AdminCategorias = ({ onSubmit, onRemove, onClickSet, onClear, idToUpdate, form, foto }) => {
    ...
    <>
      <div className='form-container'>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className='admin-form'>
          ...
          <FormInput errors={errors} register={register} name='foto' accept='image/*' type='file' foto={foto} />
