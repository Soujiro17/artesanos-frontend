...
const MapComponent = ({ geolocation = false, data }) => {
  ...
  // Si se quiere reactivar la dirección de los artesanos
  // eliminar todos los comentarios de este archivo.
  ...
  if (geolocation && errorPass && !actualAlt && !actualLon && !actualAlt)
    return <Spinner />;

  const center = data
    ? data.direccion?.coordenadas
    : geolocation && errorPass
    ? [actualLat, actualLon, actualAlt]
    : [
        import.meta.env.VITE_DIRECCION_SANMIGUEL_LATITUD,
        import.meta.env.VITE_DIRECCION_SANMIGUEL_LONGITUD,
      ];
  ...
  return (
    <div className={styles.map_wrapper}>
      ...
      >
        ...
        >
          <Popup>Municipalidad de San Miguel</Popup>
        </Marker>
